...
class HostTabBarController: RAMAnimatedTabBarController, HostTabBarDisplayLogic, LanguageRelodable {
    ...
    lazy var loginNavi: UINavigationController = {
        let navigationController = UINavigationController(rootViewController: LLLoginViewController())
        return navigationController
    }()
...
//                                                     table: .ui)
    ...
    @objc dynamic func setupBarButtonItem() {
        ...
        loginNavi.tabBarItem = createTabBarItem(title: "會員",
                                                      image: UIImage(named: "member_unselected"),
                                                      selectedImage: UIImage(named: "member"))

        viewControllers = [bankCurrencyNavi, calculatorNavi, listSettingNavi, loginNavi]
    ...
    func reloadLanguage() {
        ...
        (loginNavi.tabBarItem as? HostAnimatedTabBarItem)?.iconView?.textLabel.text = memberTitle
    }
